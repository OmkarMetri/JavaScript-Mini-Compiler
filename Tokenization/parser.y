...
%token T_VAR T_DEF T_KEY T_ID T_NUM T_LBR T_RBR T_STR T_SHA T_LCG T_LOP T_OP1 T_OP2 T_OP3 T_OP4 T_FOR T_IF T_ELSE T_IN T_LET T_CONSOLE T_DOCUMENT
%start start
...
statement: declare terminator|expr terminator|for |if | '{'{scope[stop++]=sid++;} seqOfStmts '}' {stop--;} | T_CONSOLE '(' T_STR ')' | T_DOCUMENT '(' T_STR ')' ;
